...
public interface CommentService {
    ...
    Response createComment(CreateUpdateCommentDTO request, Long postId,  String username);

    Response updateComment(CreateUpdateCommentDTO request, Long commentId, String username);

    void deleteComment(Long commentId, String username);

    CommentListDTO getCommentList(CommentListRequestDTO requestDTO);
}
